...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 48, 48, 48, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
...
MACRO_CONFIG_STR(SvRconPassword, sv_rcon_password, 32, "rcon", CFGFLAG_SERVER, "Remote console password (full access)")
